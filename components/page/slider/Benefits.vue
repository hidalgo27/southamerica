...
`,
    text: "Customized journeys, as unique as you are"
  },
  {
    icon: `<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1" stroke="currentColor" class="size-6">
...
`,
    text: "Trouble-free travel, Always supported 24/7"
  },
  {
    icon: `<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1" stroke="currentColor" class="size-6">
...
`,
    text: "Destination Experts: Your Local Advantage"
  },
  {
    icon: `<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1" stroke="currentColor" class="size-6">
...
`,
    text: "South America, reimagined for the discerning traveler"
  },
  {
    icon: `<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1" stroke="currentColor" class="size-6">
...
`,
    text: "The Art of Luxury: 5-Star Stays and Exquisite Tours"
  }
];
  ...
  <section class="py-6 rounded-md m-3">
    <div class="container">
      ...
      <carousel :wrap-around="true" :breakpoints="breakpoints">
        <slide v-for="(slide, index) in slides" :key="index" class="slide text-md px-2">
