...
`,
    text: "Tailor-made vacations as unique as you are"
  },
  {
    icon: `<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1" stroke="currentColor" class="size-6">
...
`,
    text: "24/7/365 support to ensure your trip is perfect"
  },
  {
    icon: `<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1" stroke="currentColor" class="size-6">
...
`,
    text: "Authentic experts who know your destinations"
  },
  {
    icon: `<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1" stroke="currentColor" class="size-6">
...
`,
    text: "Exclusive benefits and experiences for travelers"
  },
  {
    icon: `<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1" stroke="currentColor" class="size-6">
...
`,
    text: "Elevated journeys with 5-star stays and private tours"
  }
];
...
<template>
  <section class="py-6 rounded-md m-3">
    <div class="container">
      ...
      <carousel :wrap-around="true" :breakpoints="breakpoints">
        <slide v-for="(slide, index) in slides" :key="index" class="slide text-md">
